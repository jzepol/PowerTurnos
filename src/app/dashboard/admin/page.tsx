              ...
              <form onSubmit={(e) => {
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <select name="gymId" required className="mt-1 block w-full border-gray-300 rounded-md shadow-sm form-input">
                  ...
                  <div>
                    ...
                    <select name="userId" required className="mt-1 block w-full border-gray-300 rounded-md shadow-sm form-input">
                  ...
                  <div>
                    ...
                    <input type="text" name="reason" placeholder="Ej: Bono por buen comportamiento" className="mt-1 block w-full border-gray-300 rounded-md shadow-sm form-input" />
                  </div>
                </div>
